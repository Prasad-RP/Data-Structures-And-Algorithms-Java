 ...
 *
 */
public class SinglyCircularLinkedListOperations {
	...
	public void insertAtGivenPosition(int positionToInsert, int data) {
		...
		while (middleNode != null && currentIndex < positionToInsert - 1) {
	...
	public void deleteAtGivenPosition(int positionToDelete) {
		...
		while (middleNode != null && currentIndex < positionToDelete - 2) {
		...
		System.out.println("\nLinked List After deleting element at position: " + positionToDelete + "\n");
		displayLinkedList();
	}
	...
	public static void main(String[] args) {
		SinglyCircularLinkedListOperations list = new SinglyCircularLinkedListOperations();
		list.showMenu();
	}
}
